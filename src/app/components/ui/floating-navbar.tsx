      ...
      {isVisible && (
        ...
        >
          {navItems.map((navItem, idx) => (
            ...
            >
              <span className="block lg:hidden">{navItem.icon}</span> {/* Show icons on small screens */}
              <span className="hidden lg:block text-sm">{navItem.name}</span> {/* Show text on large screens */}
            </Link>
          ))}
        </motion.div>
      )}
